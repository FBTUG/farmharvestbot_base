#!/usr/bin/env python
# Description: node of vision manager
#    features:
#    logic:
#        
...
#vision statistic
class VisionStatistic(FhbStatistic):
...
class VisionActSrv(FhbActSrv):
    ...
    def execute_cb(self, goal):
        ...
        if goal.act_id>=Consts.ACTID_START_VISION:
            for i in range(5):
...
def main():
    ...
    vn = VisionNode()
    vn.setup()
    server = VisionActSrv("vision_act")
    vision_stat = VisionStatistic("vision")
